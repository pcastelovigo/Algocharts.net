...
<div class="header__content">
	...
	?>
        ...
        <li class="header__nav-item"><a href="https://algocharts.net/<?php echo "index.php?market=&asset_in=".$assets[0]."&asset_out=".$assets[1]."&chart=".$chart; ?>" class="header__nav-link">Tinyman</a></li>
        <li class="header__nav-item"><a href="https://algocharts.net/<?php echo "index.php?market=pactfi&asset_in=".$assets[0]."&asset_out=".$assets[1]."&chart=".$chart; ?>" class="header__nav-link">Pact.fi</a></li>
        <li class="header__nav-item"><a href="https://algocharts.net/<?php echo "index.php?market=algofi&asset_in=".$assets[0]."&asset_out=".$assets[1]."&chart=".$chart; ?>" class="header__nav-link">AlgoFi</a></li>
