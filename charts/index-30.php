...
<p>Hello tinies!! I made a small, easy to setup software (this page!!) that automagically grabs all new&amp;existing Tinyman pools, stores price data and create charts for them.</p>
...
<p>- Buying my <a href="https://app.tinyman.org/#/swap?asset_in=0&amp;asset_out=330109984">ASA ID 330109984</a></p>
...
<h2><?php echo "".$nombre1." TO ".$nombre2." 30 day view"; ?></h2>
...
<h2>Popular pools</h2>
<a href="https://freetinycharts.ovh/index-30.php?asset_in=226701642&amp;asset_out=0">Yieldy/Algorand</a>
<br>
<a href="https://freetinycharts.ovh/index-30.php?asset_in=27165954&amp;asset_out=0">Planet/Algorand</a>
<br>
<a href="https://freetinycharts.ovh/index-30.php?asset_in=230946361&amp;asset_out=31566704">AlgoGems/USDC</a>
<br>
<a href="https://freetinycharts.ovh/index-30.php?asset_in=230946361&amp;asset_out=0">AlgoGems/Algorand</a>
<br>
<a href="https://freetinycharts.ovh/index-30.php?asset_in=137594422&amp;asset_out=0">HEADLINE/Algorand</a>
<br>
</div>
...
<figure>
<a href=<?php echo '"'."https://freetinycharts.ovh/index-30.php?asset_in=".$asset_out."&amp;asset_out=".$asset_in.'"' ?>>
...
$conn = new mysqli($servername, $username, $password, $dbname);
if ($conn->connect_error) {die("Connection failed: " . $conn->connect_error);}
$sql = "SELECT fecha FROM (SELECT * FROM ".$asset_in."_".$asset_out." WHERE id % 14 = 0 ORDER BY id DESC LIMIT 196) t2 ORDER BY t2.id ASC";
$result = $conn->query($sql);
...
$conn = new mysqli($servername, $username, $password, $dbname);
if ($conn->connect_error) { die("Connection failed: " . $conn->connect_error); }
$sql = "SELECT precio FROM (SELECT * FROM ".$asset_in."_".$asset_out." WHERE id % 14 = 0 ORDER BY id DESC LIMIT 196) t2 ORDER BY t2.id ASC";
$result = $conn->query($sql);
...
function Goto() {
  ...
  var url = "https://freetinycharts.ovh/index-30.php?asset_in=" + encodeURIComponent(x) + "&asset_out=" + encodeURIComponent(y);
