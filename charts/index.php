...
<h2>Popular pools</h2>
<a href="https://freetinycharts.ovh/index.php?asset_in=226701642&amp;asset_out=0">Yieldy/Algorand</a>
<br>
<a href="https://freetinycharts.ovh/index.php?asset_in=27165954&amp;asset_out=0">Planet/Algorand</a>
<br>
<a href="https://freetinycharts.ovh/index.php?asset_in=230946361&amp;asset_out=31566704">AlgoGems/USDC</a>
<br>
<a href="https://freetinycharts.ovh/index.php?asset_in=230946361&amp;asset_out=0">AlgoGems/Algorand</a>
<br>
<a href="https://freetinycharts.ovh/index.php?asset_in=137594422&amp;asset_out=0">HEADLINE/Algorand</a>
<br>
</div>
...
$conn = new mysqli($servername, $username, $password, $dbname);
if ($conn->connect_error) {die("Connection failed: " . $conn->connect_error);}
$sql = "SELECT fecha FROM (SELECT * FROM ".$asset_in."_".$asset_out." ORDER BY id DESC LIMIT 196) t2 ORDER BY t2.id ASC";
$result = $conn->query($sql);
...
$conn = new mysqli($servername, $username, $password, $dbname);
if ($conn->connect_error) { die("Connection failed: " . $conn->connect_error); }
$sql = "SELECT precio FROM (SELECT * FROM ".$asset_in."_".$asset_out." ORDER BY id DESC LIMIT 196) t2 ORDER BY t2.id ASC";
$result = $conn->query($sql);
