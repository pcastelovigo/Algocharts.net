...
$conn = new mysqli($servername, $username, $password, $dbname);
if ($conn->connect_error) {die("Connection failed: " . $conn->connect_error);}
$sql = "SELECT fecha FROM ".$asset_in."_".$asset_out." WHERE id % 176 = 0 ORDER BY id ASC LIMIT 196";
$result = $conn->query($sql);
...
$conn = new mysqli($servername, $username, $password, $dbname);
if ($conn->connect_error) { die("Connection failed: " . $conn->connect_error); }
$sql = "SELECT precio FROM ".$asset_in."_".$asset_out." WHERE id % 176 = 0 ORDER BY id ASC LIMIT 196";
$result = $conn->query($sql);
